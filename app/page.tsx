...
// region 字段预留扩展：canada | usa | europe | asia
const CITIES = [
  { id: 'vancouver', name: '温哥华', nameEn: 'Vancouver',  province: '不列颠哥伦比亚省', provinceShort: 'BC', region: 'canada' },
  { id: 'toronto',   name: '多伦多', nameEn: 'Toronto',    province: '安大略省',           provinceShort: 'ON', region: 'canada' },
  { id: 'calgary',   name: '卡尔加里', nameEn: 'Calgary',  province: '艾伯塔省',           provinceShort: 'AB', region: 'canada' },
  { id: 'montreal',  name: '蒙特利尔', nameEn: 'Montréal', province: '魁北克省',           provinceShort: 'QC', region: 'canada' },
  { id: 'ottawa',    name: '渥太华', nameEn: 'Ottawa',     province: '安大略省',           provinceShort: 'ON', region: 'canada' },
]
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-10">
        ...
        <div className={`text-center mb-7 transition-all duration-700 ${started ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <h1 className="text-4xl font-bold text-white leading-tight mb-2" style={{ letterSpacing: '-1px' }}>
            ...
            这些事要花你多少
            <span style={{ background: 'linear-gradient(135deg, #4F8EF7, #5B5CF0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>人生</span>？
          </h1>
        ...
        {step === 1 && (
          <div className={`transition-all duration-500 ${started ? 'opacity-100' : 'opacity-0'}`}>
            <div className="text-xs text-white/30 uppercase tracking-widest text-center mb-5">第一步 · 选择你的城市</div>
        ...
        {step === 2 && (
          <div className="transition-all duration-500">
            <div className="text-xs text-white/30 uppercase tracking-widest text-center mb-5">第二步 · 选择目标类型</div>
            ...
            {(selectedPurpose === 'buy' || selectedPurpose === 'rent') && (
              <div className="mb-5">
                <div className="text-xs text-white/30 uppercase tracking-widest text-center mb-3">选择房型</div>
            ...
            {selectedPurpose === 'car' && (
              <div className="mb-5">
                <div className="text-xs text-white/30 uppercase tracking-widest text-center mb-3">选择车型</div>
        ...
        {step === 3 && (
          <div className="transition-all duration-500">
            <div className="text-xs text-white/30 uppercase tracking-widest text-center mb-5">第三步 · 选择你的职业</div>
